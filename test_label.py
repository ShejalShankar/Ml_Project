...
path = "Dataset1/TUSimple/"
#files = ['label_data_0313.json','label_data_0531.json','label_data_0601.json']
test_samples = []
json_gt = [json.loads(line) for line in open('Dataset1/TUSimple/test_set/test_label_new.json')]
...
with open(path + 'testing_sample.pkl', 'wb') as f:
